...
1. the AgriScale RN `v1.2.7` Singularity Image Format (`.sif`) container, which holds the scientific software stack;
...
1. Open the Agriscale Container release page:
   ...
   https://github.com/CropModelingPlatform/AgriscaleContainer/releases/tag/v1.2.7
